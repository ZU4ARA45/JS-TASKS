...
/*task 2 
Измените функцию "square" так, чтобы в случае ее вызова без аргумента 
генерировалась консольная ошибка (console.error):
...
Если они совпали, то возвращает “Вы выиграли”, 
если нет - то “Вы не угадали, ваше число -  ...,  а выпало число ...”
...
let guessTheNumber = (number, randomNumber) => {
...
const newArrayNumbers = arrayNumbers.map(function newArray(arr) {
    return arr
})
