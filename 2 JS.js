...
let number1 = prompt('Введите одно число ');
let number2 = prompt('Введите другое число ');
...
let middlegrade = prompt('Введите ваш средний бал: ');
...
console.log("С вас ровно " + equation + '$');*/
